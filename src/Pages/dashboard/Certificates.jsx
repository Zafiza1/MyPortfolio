...
import { getCertificates, createCertificate, deleteCertificate as deleteCertificateApi, uploadImage } from "../../api";
...
export default function Certificates() {
  ...
  const uploadImageCert = async () => {
    if (!file) return
    setUploading(true)
    try {
      const data = await uploadImage(file)
      await createCertificate(data.url)
          ...
          {file && (
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button onClick={uploadImageCert} disabled={uploading} className="relative group/u">
