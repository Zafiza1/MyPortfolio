...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/zafi-zunaidi-aziz-b6618a2b8",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@zafiza_1",
    icon: Instagram,
    url: "https://www.instagram.com/zafiza_1/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@eki zulfar",
    icon: Youtube,
    url: "https://www.youtube.com/@channel_kamu",
    color: "#FF0000",
