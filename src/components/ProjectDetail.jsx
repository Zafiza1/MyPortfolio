...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Zafiza1",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Zafi Zunaidi Aziz</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Zafi Aziz — Full Stack Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Zafi Aziz`}
        />
        <meta
