...
import { getProjects, createProject, updateProject, deleteProject as deleteProjectApi, uploadImage } from "../../api";
import {
  Plus,
  Trash2,
  Upload,
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <InputField
          ...
          value={form.Github}
          onChange={set("")}
          placeholder="https://.com/username/repo"
        />
...
export default function Projects() {
  ...
  const handleUploadImage = async (f) => {
  ...
  const handleCreate = async (form, file) => {
    ...
    try {
      let imgUrl = "";
      if (file) imgUrl = await handleUploadImage(file);
